export function OperationDiagram() {
  return <figure className="operation-visual" data-motion-level="graphic" aria-label="Diagrama conceptual: conectar ventas, operación e información para tomar mejores decisiones.">
    ...
    <div className="flow-core" aria-hidden="true"><span className="core-symbol">i<span /></span><div>Todo empieza a conectar.<small>Procesos + datos + tecnología</small></div><span className="core-check">✓</span></div>
